                    ...
                    Eigen::Vector3d& desired_acc )
{
    ...
    double P_x[poly_order*(point_num-1)] = { 0.00000, 0.00000, 0.00000, 0.00000, 0.11838,-0.05254, 0.00829,-0.00046,
    ...
    double P_y[poly_order*(point_num-1)] = { 0.00000, 0.00000, 0.00000, 0.00000, 0.05672,-0.02526, 0.00408,-0.00023, 
    ...
    double P_z[poly_order*(point_num-1)] = { 0.50000, 0.00000, 0.00000, 0.00000, 0.01129,-0.00496, 0.00079,-0.00004, 
    ...
    {
      desired_p[0] = desired_p[0] + P_x[j+Poly_order*Segment] * pow((dT - T_segment[Segment]), j);
      desired_p[1] = desired_p[1] + P_y[j+Poly_order*Segment] * pow((dT - T_segment[Segment]), j);
      desired_p[2] = desired_p[2] + P_z[j+Poly_order*Segment] * pow((dT - T_segment[Segment]), j);
      
      desired_v[0] = desired_v[0] + j * P_x[j+Poly_order*Segment] * pow((dT - T_segment[Segment]), (j-1));
      desired_v[1] = desired_v[1] + j * P_y[j+Poly_order*Segment] * pow((dT - T_segment[Segment]), (j-1));
      desired_v[2] = desired_v[2] + j * P_z[j+Poly_order*Segment] * pow((dT - T_segment[Segment]), (j-1));
